        ...
        <?php if ('style-1' === $settings['eael_pricing_table_style']) : ?>
            <div class="eael-pricing style-1" <?php echo $inline_style; ?>>
                <div class="eael-pricing-item <?php echo esc_attr($featured_class); ?>">
                   ...
                   <?php 
                 if (isset($settings['eael_pricing_table_button_show']) && $settings['eael_pricing_table_button_show'] == 'yes'): ?>
                    <div class="footer">
                        <a <?php echo $this->get_render_attribute_string('eael_pricing_button'); ?>>
                            <?php 
                            $icon_position = isset($settings['eael_pricing_table_button_icon_position']) ? $settings['eael_pricing_table_button_icon_position'] : 'left'; // Default to 'left' if not set
            ...
            <div class="eael-pricing style-2" <?php echo $inline_style; ?>>
                <div class="eael-pricing-item <?php echo esc_attr($featured_class); ?>">
                    ...
                    <div class="body">
                        ...
                        <?php if(isset($settings['eael_pricing_table_button_show']) && $settings['eael_pricing_table_button_show'] == 'yes'): ?>
                            <div class="footer">
                        <a <?php echo $this->get_render_attribute_string('eael_pricing_button'); ?> >
